    ...
    <div class="flex flex-col w-64">
      ...
      <div class="flex flex-col flex-grow pb-4 overflow-y-auto bg-white ">
        <div class="px-4 pt-1.5 pb-1.5 navcolor">
         <a href="{{route('homepage')}}"><svg xmlns="http://www.w3.org/2000/svg" width="60" height="53" viewBox="0 0 60 53">
        ...
        <div class="flex flex-col flex-grow mt-5">
          <nav class="flex-1 px-2 space-y-1 bg-white">
            ...
            <a href="{{route('adminDashboard')}}" class="flex items-center px-2 py-2 text-sm font-medium text-gray-600 border-l rounded-md hover:text-blue-800 hover:border-blue-500 hover:bg-blue-200 group">
              <!--
            ...
            <a href="{{route('viewVL')}}" class="flex items-center px-2 py-2 text-sm font-medium text-gray-600 border-l rounded-md hover:text-blue-800 hover:border-blue-500 hover:bg-blue-200 group">
            ...
            <a href="{{route('viewML')}}" class="flex items-center px-2 py-2 text-sm font-medium text-gray-600 border-l rounded-md hover:border-blue-500 hover:bg-blue-200 hover:text-blue-800 group">
            ...
            <a href="{{route('viewOL')}}" class="flex items-center px-2 py-2 text-sm font-medium text-gray-600 border-l rounded-md hover:text-blue-800 hover:border-blue-500 hover:bg-blue-200 group">
            ...
            <a href="{{route('signoutAdmin')}}" class="flex items-center px-2 py-2 text-sm font-medium text-gray-600 border-l rounded-md hover:text-blue-800 hover:border-blue-500 hover:bg-blue-200 group">
