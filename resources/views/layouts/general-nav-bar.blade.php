...
<body>
      ...
      <!-- component -->
  <nav class="flex flex-col content-center w-full px-6 py-2 font-sans text-center shadow navcolor sm:flex-row sm:text-left sm:justify-between sm:items-baseline">
    ...
    <div class="self-center">
      <a href="{{route('homepage')}}" class="font-sans text-2xl font-bold text-white no-underline hover:text-blue-dark ">Half Time Car Rental</a><br>
    ...
    <div class="flex justify-center sm:mb-0 center-items">
      ...
      {{--  <a href="#" class="px-1 ml-2 text-white no-underline text-md hover:text-blue-dark">Sign up</a>  --}}
      <a href="{{route('showLogin')}}" class="px-1 ml-2 text-white no-underline text-md hover:text-blue-dark">Sign in</a>
  ...
  <nav class="flex flex-col content-center w-full px-6 py-2 font-sans text-center bg-gray-100 shadow sm:flex-row sm:text-left sm:justify-between sm:items-baseline">
                  ...
                  <div class="w-full">
                      <form method="post" action="{{route('homeSearch')}}">
                       @csrf <input type="text" class="w-full px-4 py-1 text-gray-800 rounded-full focus:outline-none"
                        ...
                        <div class="ml-48">
                          <button type="submit" class="flex items-center justify-center w-12 h-12 text-white rounded-r-lg navcolor"
    ...
    <div class="self-center sm:mb-0">
      <!-- <div class="h-10" style="display: table-cell, vertical-align: middle;"> -->
      <a href="{{route('aboutus')}}" class="px-1 ml-2 no-underline text-md text-blue-dark hover:text-blue-dark">About us</a>
      <a href="{{route('contact')}}" class="px-1 ml-2 no-underline text-md text-blue-dark hover:text-blue-dark">Contact us</a>
      <!-- </div> -->
  ...
  {{-- FOOTER --}}
<footer class="cardfounder MT-5" aria-labelledby="footer-heading">
  <h2 id="footer-heading" class="sr-only">Footer</h2>
  <div class="px-4 pt-12 pb-5 mx-auto max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
      ...
      <div class="grid grid-cols-2 gap-8 xl:col-span-2">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div class="mt-12 md:mt-0">
            <h3 class="text-sm font-semibold tracking-wider text-gray-400 uppercase">
              Subscribe to Half Time Rental via Email
            </h3>
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="#" class="text-base text-black hover:text-black">
                  Get in the know byt subscribing to our email listing. Welcome aboard!
                </a>
              </li>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="{{route('aboutus')}}" class="text-base text-black hover:text-black">
                  About
                </a>
              </li>
      ...
      <div class="mt-8 xl:mt-0">
        ...
        <form class="mt-4 sm:flex sm:max-w-md">
          ...
          <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <button type="submit" class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white border border-transparent rounded-md navcolor hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Subscribe
            </button>
          </div>
        </form>
...
<section>
  <div class="px-5 py-8 border-t border-gray-200 navcolor md:flex md:items-center md:justify-between">
